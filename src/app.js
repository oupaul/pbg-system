...
try {
  ...
  const pipelineAmountOptionsRoutes = require('./routes/pipelineAmountOptions');
  console.log('[啟動] ✓ pipelineAmountOptions 路由載入完成');
  const bonusTypesRoutes = require('./routes/bonusTypes');
