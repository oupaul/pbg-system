...
router.post('/', async (req, res) => {
  try {
    ...
    const permissions = {
      ...
      can_edit_crm: req.body.can_edit_crm === 'on' ? 1 : 0,
      can_approve_customer: req.body.can_approve_customer === 'on' ? 1 : 0,
      can_approve_invoice_request: req.body.can_approve_invoice_request === 'on' ? 1 : 0,
